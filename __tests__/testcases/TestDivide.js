...
winston.configure({
  transports: [new winston.transports.File({ filename: "./__tests__/logs/Divide_logs.txt" })],
});
...
async function TestDivide() {
    ...
    await keys.divide.click();
    winston.info("divide clicked");
